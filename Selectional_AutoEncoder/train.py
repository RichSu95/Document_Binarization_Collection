...
def parse_menu():
    ...
    parser.add_argument('-start_from',  default=128,                                  type=int,   help='Start from this page')
    ...
    parser.add_argument('-loadmodel', default = 'model_weights_dibco_4_256x256_s128_f64_k3_s2_se1_e200_b10_esp.h5', type=str,   help='Weights filename to load for test')
