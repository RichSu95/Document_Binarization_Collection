...
def parse_menu(activate_demo_opt = False):
    ...
    parser.add_argument('-imgpath',    default= 'image_test/0.png',        help='Path to the image to process')
    parser.add_argument('-modelpath',   default='model_weights_dibco_4_256x256_s128_f64_k3_s2_se1_e200_b10_esp.h5_ftunedibco4.h5',
                                                    help='Path to the model to load')
    parser.add_argument('-w',        default=256,    dest='window',              type=int,   help='Window size')
    parser.add_argument('-s',        default=128,     dest='step',                type=int,   help='Step size. -1 to use window size')
    parser.add_argument('-f',        default=64,     dest='nb_filters',          type=int,   help='Nb. filters')
    parser.add_argument('-k',        default=3,      dest='kernel',              type=int,   help='Kernel size')
