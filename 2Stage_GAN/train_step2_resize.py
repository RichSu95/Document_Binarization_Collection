...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='dibco_resize_6_4/train/image/', help='512 resized image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='dibco_resize_6_4/train/mask/', help='512 resized mask train dir')
