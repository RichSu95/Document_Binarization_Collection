...
def main(argv=None):
    ...
    image_save_dir = './image_patches'
    mask_save_dir = './mask_patches'
    ...
    for image_path in image_pathes:
        ...
        elif os.path.isfile(os.path.join(mask_dir, image_name) + '.tif'):
            mask = cv2.imread(os.path.join(mask_dir, image_name) + '.tif', cv2.IMREAD_GRAYSCALE)
        elif os.path.isfile(os.path.join(mask_dir, image_name) + '.tiff'):
            mask = cv2.imread(os.path.join(mask_dir, image_name) + '.tiff', cv2.IMREAD_GRAYSCALE)
