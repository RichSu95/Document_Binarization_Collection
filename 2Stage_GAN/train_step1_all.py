...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='image_patches/', help='patched image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='mask_patches/', help='patched mask train dir')
