...
def train_gan(generator,discriminator, ep_start=1, epochs=1, batch_size=128):
    ...
    for e in range(ep_start, epochs+1):
        ...
        if (e == 1 or e%10==0):
          ...
          discriminator.save_weights('./last_trained_weights/last_discriminator_weights'+str(e)+'.h5')
          generator.save_weights('./last_trained_weights/last_generator_weights'+str(e)+'.h5')
        #if (e == 1 or e % 10 == 0):
...
def predic(generator, epoch):
    ...
    for i in range(0,16):
        watermarked_image_path = ('CLEAN/VALIDATION/DATA/'+ str(i) + '.png')
        ...
        imageio.imwrite('Results/epoch'+str(epoch)+'/predicted'+str(i)+'.png', predicted_image)
...
def  evaluate(generator,discriminator,epoch):
    ...
    for i in range (0,16):
        ...
        test_image= plt.imread('CLEAN/VALIDATION/GT/'+ str(i) + '.png')

        predicted_image= plt.imread('Results/epoch'+str(epoch)+'/predicted'+ str(i) + '.png')
...
###############################################
train_gan(generator,discriminator, ep_start =epo, epochs=200, batch_size=4)
